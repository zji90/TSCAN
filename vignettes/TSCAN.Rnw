...
Now we use the Human Skeletal Muscle Myoblasts (HSMM) single-cell RNA-seq data [4] to demonstrate how TSCAN can be used to construct pseudotemporal cell ordering using TSP.
