#' SCAtoolsui
#' 
#' Launch the SCAtools user interface in local machine
#'
#' This function will automatically launch the SCAtools user interface in a web browser. 
...
#' The user interface can also be accessed by http://zhiji.shinyapps.io/SCAtools. Neither R nor any packages are required in this online version.
...
SCAtoolsui <- function() {
      library(shiny)
      shiny::runApp(system.file("shiny",package="SCAtools"))
}
